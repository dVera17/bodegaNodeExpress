...
__decorate([
    ...
    Transform(({ value }) => {
        if (/^[0-9]+$/.test(value) && typeof value === 'number' && value != undefined)
            ...
            throw { status: 401, message: "El dato que esta tratando de ingresar en id_responsable es invalido" };
    }),
...
__decorate([
    ...
    __metadata("design:type", Number)
], bodegas.prototype, "status", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Number)
], bodegas.prototype, "updatesBy", void 0);
